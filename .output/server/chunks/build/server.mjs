...
import { $ as $fetch, l as hasProtocol, m as isScriptProtocol, n as joinURL, w as withQuery, o as defu, p as sanitizeStatusCode, q as getContext, t as createHooks, c as createError$1, v as toRouteMatcher, x as createRouter$1 } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "coverFlow",
    path: "/coverFlow",
    component: () => import('./index-BZTL8aFG.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-0FZ_55X6.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-5x3BDBM_.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-a2QWp3dQ.mjs'));
